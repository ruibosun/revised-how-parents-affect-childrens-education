...
p1 <- ggplot(cleaned_data, aes(x=educ, y=papres10)) +
  ...
  ggtitle("Father's Prestige Score vs Children's Education") +
  labs(x="Education (in Years)", y="Father's Prestige Score")+
  theme_bw()
p2 <- ggplot(cleaned_data, aes(x=educ, y=mapres10)) +
  geom_point(color="darkgreen",size=2) +
  ggtitle("Mother's Prestige Score vs Children's Education") +
...
labs(title = "Mother's Education and Father's Education Level",
...
ggplot(cleaned_data, aes(x = educ, fill = factor(born))) +
  geom_histogram(position = "dodge", binwidth = 1.5, alpha = 0.5, color = "black")+
   labs(title = "Education and Birthplace (if outside of US) for the Respondent",
       x = "Education (in Years)",
       y = "Count",
       fill = "Birthplace of the Respondent (if outside of US)")+
  theme_bw()
```
...
ggplot(cleaned_data, aes(x = educ, y = maeduc, color = incom16)) +
  ...
  facet_wrap(~incom16)+
  labs(title = "Education vs Mother's Education with respect to Family Income",
       x = "Education (in Years)",
...
ggplot(cleaned_data, aes(x = educ, y = paeduc, color = incom16)) +
  ...
  stat_smooth(method = "lm", se = FALSE) +
  facet_wrap(~incom16)+
  labs(title = "Education vs Father's Education with respect to Family Income",
       x = "Education (in Years)",
